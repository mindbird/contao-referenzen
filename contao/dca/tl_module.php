<?php
$GLOBALS ['TL_DCA'] ['tl_module'] ['palettes'] ['reference_list'] = '{title_legend},name,headline,type;{archiv_legend},reference_archiv,jumpTo,reference_random,reference_filter_disabled,numberOfItems,perPage,imgSize,referenceTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
